...
public class FileUploadDemo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * 准备： 导入两个jar文件&页面3处 1. 创建工厂类 2. 创建解析器ServletFileUpload//ServletFileUpload 3.
		 * 使用ServletFileUpload中的List<FileItem> parseRequest(request) 4.
		...
		// 设置单个文件的上传大小
		upload.setFileSizeMax(2 * 1024);//2k
